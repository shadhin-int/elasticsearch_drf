    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('published', 'published'), ('not_published', 'not_published'), ('in_progress', 'in_progress'), ('cancelled', 'cancelled'), ('rejected', 'rejected')], default='published', max_length=100)),
